 ...
 */
export function getStellarContracts(network: 'mainnet' | 'testnet') {
  return {
    factory: STELLAR_CONTRACTS.FACTORY[network.toUpperCase() as 'MAINNET' | 'TESTNET'],
    htlcWasmHash: STELLAR_CONTRACTS.HTLC_WASM_HASH,
    nativeToken: STELLAR_CONTRACTS.NATIVE_TOKEN[network.toUpperCase() as 'MAINNET' | 'TESTNET'],
    usdc: STELLAR_CONTRACTS.USDC[network.toUpperCase() as 'MAINNET' | 'TESTNET'],
  };
}
 ...
 */
export function isFactoryConfigured(network: 'mainnet' | 'testnet'): boolean {
