...
/**
 * @title ResolverV2
 * @notice Enhanced Resolver with Stellar confirmation requirement
 * @dev Prevents Base withdrawal until Stellar side is confirmed
 */
contract ResolverV2 is Ownable {
    ...
    // Mapping from orderHash to Stellar confirmation status
    mapping(bytes32 => bool) public stellarConfirmed;
    
    // Trusted oracle/relayer that confirms Stellar transactions
    ...
    /**
     * @notice Update Stellar oracle address
    ...
    /**
     * @notice Confirm Stellar escrow deployment
     * @param orderHash The order hash
     * @param stellarEscrow The Stellar escrow address
     */
    ...
    /**
     * @notice Withdraw funds using revealed secret (with Stellar confirmation requirement)
    ...
    /**
     * @notice Emergency withdraw without Stellar confirmation (owner only, after timelock)
     * @param escrow The escrow contract address
     * @param secret The revealed secret
     */
